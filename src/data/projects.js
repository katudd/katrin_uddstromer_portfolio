export default [
  ...
  // }, {
    ...
    longdescription: "A classic To do app built using React. The assignment focus on building the form, handling state changes and use local storage to save state so that when the user reloads the page, they don't lose their todos. I built it with three components – one for the input, one for the item and then App that stores an array of todo objects and then render the items as a list.",
    link: "https://katudd.github.io/todo-app/",
    category: "code",
    image: "/images/to_do_personal_desktop.png",
    image2: "/images/to_do_personal_mobile.png"
  }, {
    id: "css-grid",
    name: "CSS Grid",
    ...
    longdescription: "A project built in React, using Sveriges Radio API to fetch() to get a JSON from the Sveriges Radio API and render a list of channels with playable audio streams urls to create a working radio player. I built it with two components – one for the player and App where I map over the the channels in the JSON.",
    ...
    category: "code",
    image: "/images/cookie_calendar_desktop.png",
